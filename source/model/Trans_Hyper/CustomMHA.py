...
from torch.nn.functional import pad, softmax, dropout, linear, scaled_dot_product_attention
from torch.overrides import has_torch_function, handle_torch_function
from torch.sparse import DType
...
def multi_head_attention_forward(
    ...
    need_weights_before_softmax: bool = True,
    ...
    if need_weights:
        ...
        attn_weights_before_softmax = attn_output_weights
        ...
        if average_attn_weights:
            ...
            attn_weights_before_softmax = attn_weights_before_softmax.mean(dim=1)
        ...
        if need_weights_before_softmax:
